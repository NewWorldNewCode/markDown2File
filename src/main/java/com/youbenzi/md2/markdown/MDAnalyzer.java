			...
			if(j>-1){	//该语法完整
				...
				if(linkOrImageBeanTmp!=null){
					...
					if(linkOrImageBeanTmp.isLink()){
						...
						//modified by sun 将带有链接的汉字后面的地址隐去
						//String tmpValue = valuePart.getTitle();
...
//		String text = "1231**12_3_3**123123";
//		String text = "1231*12_3_3**123123";
//		String text = "3**123123";
//		String text = "   [Nodejs 文档](https://nodejs.org/documentation/)";
//		System.out.println(analyzeTextLine(text));
//		System.out.println(text);
//		System.out.println(isOrderedList("1.123"));
